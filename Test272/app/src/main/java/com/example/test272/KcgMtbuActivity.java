...
public class KcgMtbuActivity extends AppCompatActivity {
        ...
        kcg_mtbu_button_get_data.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try{
                            ...
                            new Response.Listener<JSONObject>() {
                                ...
                                public void onResponse(JSONObject response) {
                                    ...
                                    try{
                                        ...
                                        kcg_mtbu_arrayAdapter = new ArrayAdapter<String>(KcgMtbuActivity.this,
                                        ...
                                        kcg_mtbu_listview_apidata.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                            ...
                                            public void onItemClick(AdapterView<?> parent,View view, int position, long id) {
                                                ...
                                                int intStartOfName= kcg_mtbu_ItemString.indexOf("-");
                                                String strGeoName = kcg_mtbu_ItemString.substring(intStartOfName +1,intStartOfGeo);
                                                Toast.makeText(KcgMtbuActivity.this, strGeoName, Toast.LENGTH_LONG).show();
                                                String strArrayLatLng[] = strGeoPosition.split(",");
                                                String strLabel = strArrayLatLng[0] + "," + strArrayLatLng[1]+ "("+ strGeoName + ")";
                    ...
                    Volley.newRequestQueue( KcgMtbuActivity.this).add(request);
                    kcg_mtbu_textview_title.setText(strKcgMtbu+"\nAPI資料正在讀取中...");
